module {
  func.func @kernel_bicg(%arg0: i32, %arg1: i32, %arg2: memref<?x128xf32>, %arg3: memref<?xf32>, %arg4: memref<?xf32>, %arg5: memref<?xf32>, %arg6: memref<?xf32>)  {
    ...
    affine.for %arg7 = 0 to 128 {
      ...
      affine.for %arg8 = 0 to 128 {
        ...
        %2 = affine.load %arg2[%arg7, %arg8] : memref<?x128xf32>
        %3 = arith.mulf %1, %2 : f32
        %4 = arith.addf %0, %3 : f32
        affine.store %4, %arg3[%arg8] : memref<?xf32>
        %5 = affine.load %arg4[%arg7] : memref<?xf32>
        %6 = affine.load %arg2[%arg7, %arg8] : memref<?x128xf32>
