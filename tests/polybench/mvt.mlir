module  {
  func.func @kernel_mvt(%arg0: i32, %arg1: memref<?xf32>, %arg2: memref<?xf32>, %arg3: memref<?xf32>, %arg4: memref<?xf32>, %arg5: memref<?x512xf32>)  {
    affine.for %arg6 = 0 to 512 {
      affine.for %arg7 = 0 to 512 {
        %0 = affine.load %arg1[%arg6] : memref<?xf32>
        %1 = affine.load %arg5[%arg6, %arg7] : memref<?x512xf32>
    ...
    affine.for %arg6 = 0 to 512 {
      affine.for %arg7 = 0 to 512 {
        ...
        %1 = affine.load %arg5[%arg7, %arg6] : memref<?x512xf32>
